...
fun SignInScreen(
    ...
    Layout(
        ...
        emailError = when (viewModel.emailError) {
            SignInViewModel.EmailError.INVALID -> stringResource(id = R.string.sign_in_email_error_invalid)
            SignInViewModel.EmailError.REQUIRED -> stringResource(id = R.string.sign_in_email_error_required)
            null -> ""
        },
        passwordError = when (viewModel.passwordError) {
            SignInViewModel.PasswordError.REQUIRED -> stringResource(id = R.string.sign_in_password_error_required)
            null -> ""
        },
        ...
        onGoogleClick = {
            onGoogleClick(viewModel.signInIntent, googleSignInLauncher)
        },
        ...
        content = {
            Column(
                ...
                Row(
                    ...
                    Text(stringResource(id = R.string.sign_in_social_medias_buttons_title))
                }
                Spacer(modifier = Modifier.height(16.dp))
                Row(
...
private fun EmailField(
    ...
    UiTextField(
        ...
        label = stringResource(R.string.sign_in_mail_title),
        hint = stringResource(R.string.sign_in_mail_hint),
        error = error,
    )
}
...
private fun PasswordField(
    ...
    UiTextField(
        ...
        label = stringResource(R.string.sign_in_password_title),
